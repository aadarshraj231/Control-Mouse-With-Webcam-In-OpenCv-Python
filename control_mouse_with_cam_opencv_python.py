#Google Code In
#Control Mouse With Camera In OpenCv Python

#importing cv2 for computer vision
import cv2
...
#cv2.VideoCapture(0) is Your Camera Is Enabled 0 means your first camera
#if you replace 0 to 1 then your second camera open if second camera have
...
#Storing A posYList
posYList=list()
#Storing How many Click clickHistory
clickHistory=list()
...
while ret:
    ...
    cv2.imshow("Google_Code_In",flipped)
